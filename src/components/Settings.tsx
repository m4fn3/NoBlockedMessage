        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <View style={styles.title}>
                    <Text style={styles.name}>NoBlockedMessage</Text>
             ...
             <FormSection title="SETTING">
                <FormRow
                    ...
                    trailing={
                        <FormSwitch
                            value={settings.getBoolean("replies",true)}
                            onValueChange={(value) => {
                                settings.set("replies", value)
                            }}
                        />
                    }
                />
            ...
            <FormSection title="INFORMATION">
                ...
                <FormRow
                    ...
                    onPress={() => {
                        Linking.openURL("https://github.com/m4fn3/NoBlockedMessage")
                    }}
                />
            </FormSection>
